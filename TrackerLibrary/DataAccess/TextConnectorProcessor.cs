...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        public static List<TournamentModel> convertTournamentModels(this List<string> lines, string teamFileName, string peopleFileName, string prizeFileName)
        {
        ...
        {
            List<MatchupModel> matchups = GlobalConfig.MatchupEntryFile.fullFilePath().LoadFile().ConvertToMatchupModels();
            int currentId = 1;
            if (matchups.Count > 0)
            {
            ...
            {
                entry.SaveEntryToFile(matchupFile);
            }
